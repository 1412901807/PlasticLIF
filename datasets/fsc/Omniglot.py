...
_Omniglot_DATASET_DIR = '/mnt/home/liweiyi/PlasticLIF/datasets/fsc/data/Omniglot'
...
class Omniglot(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False):
        ...
        self.phase = phase
        self.name = 'Omniglot' + phase

        print('Loading Omniglot dataset - phase {0}'.format(phase))
        file_train_categories_train_phase = os.path.join(
            _Omniglot_DATASET_DIR,
            'train.pickle')
        ...
        if (self.phase=='test' or self.phase=='val') or (do_not_use_random_transf==True):
            ...
            self.transform = transforms.Compose([
                transforms.RandomCrop(105, padding=8), #TODO: check this
...
class FewShotDataloader():
    ...
    def get_iterator(self, epoch=0):
        ...
        # print(f"data_loader type: {type(data_loader)}"):<class 'torch.utils.data.dataloader.DataLoader'>
        return data_loader
